...
<body>
    ...
    <table>
        <tr><th>Forma de Pago</th><th>Monto</th></tr>
        <tr><td>Efectivo Pesos</td><td><input id="ecop" data-moneda="COP" data-forma-id="1" type="number" step="0.01" /></td></tr>
        <tr><td>Efectivo Dólares</td><td><input id="eusd" data-moneda="USD" data-forma-id="2" type="number" step="0.01" /></td></tr>
        <tr><td>Efectivo Bolívares</td><td><input id="ebss" data-moneda="BSS" data-forma-id="3" type="number" step="0.01" /></td></tr>
        <tr><td>Bancolombia</td><td><input id="bcop" data-moneda="COP" data-forma-id="4" type="number" step="0.01" /></td></tr>
        <tr><td>Zelle</td><td><input id="zusd" data-moneda="USD" data-forma-id="5" type="number" step="0.01" /></td></tr>
        <tr><td>Binance</td><td><input id="busd" data-moneda="USD" data-forma-id="6" type="number" step="0.01" /></td></tr>
        <tr><td>Pago Móvil</td><td><input id="bbss" data-moneda="BSS" data-forma-id="7" type="number" step="0.01" /></td></tr>
        <tr><td>Punto de Venta</td><td><input id="tbss" data-moneda="BSS" data-forma-id="8" type="number" step="0.01" /></td></tr>
        <tr><td><strong>Total Pedido en COP</strong></td><td><span id="totalPedido"><?php echo number_format($AMT_Pedido, 2); ?></span></td></tr>
        <tr><td><strong>Total Pagado en COP</strong></td><td><span id="sumpagado">0.00</span></td></tr>
        <tr><td><strong>Sobrante o Faltante en COP</strong></td><td><span id="diferencia">0.00</span></td></tr>
    </table>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("guardarPago").addEventListener("click", () => {
                ...
                const pendienteCobrar = document.getElementById("pendienteCobrar").checked;
                const valeEmpleados = document.getElementById("valeEmpleados").checked;
                const organismos = document.getElementById("organismos").checked;
